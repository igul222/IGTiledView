...
// Used for sorting an array of CellInfos.
...
- (void)removeCellWithInfo:(DTGridViewCellInfo *)info {
	...
	// prevent cell from being freed before we add it to the reuse queue
	[cell retain];
